...
`list --agents` names the session living in each, and `cleanup` refuses to sweep a worktree one is working
in.
...
**Its §-numbers are cited from source comments** — `grep -rn 'AGENT-MODE-PLAN' src/` — so the section
...
**Tied to:** Phase 2 · **Raised:** 2026-09-06 (Gate 2, reviewer subagent, Phase 1)
...
**Tied to:** Phase 2 · **Raised:** 2026-09-06 (Gate 2, reviewer subagent, Phase 2)
...
**Tied to:** Phase 3 · **Raised:** 2026-09-06 (Gate 2, reviewer subagent, Phase 3)
...
**Tied to:** Phase 5 · **Raised:** 2026-09-06 (Gate 2, reviewer subagent, Phase 3)
...
**Tied to:** Phase 5 · **Raised:** 2026-09-06 (Gate 2, reviewer subagent, Phase 5)
...
**Tied to:** Phase 7 · **Raised:** 2026-09-06 (hand, prompted by the maintainer asking whether
