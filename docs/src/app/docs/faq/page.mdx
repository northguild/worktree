...
Only worktrees that were actually removed. One held back for uncommitted changes or a live agent
keeps its space, and so does a removal you declined — in each case the checkout is still on disk. If
