...
description: >
  ...
  herdr.focus, herdr.agent, github.token, jira.host, jira.email,
  jira.apiToken, branchPrefix.feature, branchPrefix.bugfix,
...
# herdr), codeEditor (e.g. code), herdr.focus, herdr.agent
